...
const categoryLabels: Record<string, string> = {
  ...
  counting: "排列组合与概率",
  materials: "素材库",
  "training-cognition": "21 天精讲 · 认知重建（Day 1-4）",
  "training-reading": "21 天精讲 · 阅读理解（Day 5-8）",
  "training-core": "21 天精讲 · 核心能力（Day 9-12）",
  "training-article": "21 天精讲 · 大作文攻坚（Day 13-17）",
  "training-document": "21 天精讲 · 公文写作（Day 18-19）",
  "training-sprint": "21 天精讲 · 冲刺收官（Day 20-21）",
  "standard-terms": "规范词卡片",
  politics: "政治理论",
  management: "管理常识",
};
