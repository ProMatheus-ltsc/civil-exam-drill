...
const categoryLabels: Record<string, string> = {
  ...
  counting: "排列组合与概率",
  materials: "素材库",
  "training-cognition": "精讲 · 认知重建（Day 1-4）",
  "training-reading": "精讲 · 阅读理解（Day 5-10）",
  "training-core": "精讲 · 核心能力（Day 11-20）",
  "training-article": "精讲 · 大作文攻坚（Day 21-29）",
  "training-document": "精讲 · 公文写作（Day 30-36）",
  "training-sprint": "精讲 · 冲刺收官（Day 37-39）",
